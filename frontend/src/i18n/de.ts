...
export const de = {
  ...
  settings: {
    ...
    shapesAdd: 'Regel',
    shapesCalibrate: 'Ports kalibrieren',
    shapesCalibrated: (n: number) => `${n} Buchsen eingemessen`,
    shapesNotCalibrated: 'nur Symbol',
    calTitle: 'Buchsenraster einmessen',
    calHint: 'Erste und letzte Buchse eines Blocks anklicken, dann Spalten, Reihen und Zählrichtung angeben — den Abstand rechnet A38 daraus. Ohne Kalibrierung bleibt das Bild ein Erkennungszeichen und die Geräte hängen am schematischen Panel. Nur gerade Frontansichten aus dem Datenblatt taugen; ein perspektivisches Foto lässt sich mit einem Raster nicht einmessen.',
    calClickFirst: 'Jetzt die ERSTE Buchse des Blocks anklicken.',
    calClickLast: 'Jetzt die LETZTE Buchse des Blocks anklicken.',
    calBlock: 'Block',
    calCols: 'Spalten',
    calRows: 'Reihen',
    calStart: 'erste Nr.',
    calW: 'Breite',
    calH: 'Höhe',
    calOrder: 'Zählrichtung',
    calZigzag: 'oben ungerade, unten gerade',
    calRowwise: 'reihenweise (oben 1…n, unten weiter)',
    calAddBlock: 'Block (z. B. SFP)',
    calPorts: (n: number) => `${n} Buchsen im Raster`,
