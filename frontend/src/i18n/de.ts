...
export const de = {
  ...
  diagram: {
    ...
    hint: 'Netze, Kopplungen und Hosts eines VDOMs oder einer Firewall als draw.io-Datei — aus FMG-Inventar, iTop, ARP-Historie und LibreNMS. Routen zu fremden VDOMs erscheinen als Nachbarn, auch übers WAN.',
    scope: 'Scope',
    scopeVdom: 'VDOM',
