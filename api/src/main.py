...
app.include_router(diagram.router) # Netzplan als draw.io (FMG + iTop + ARP + LibreNMS)
app.include_router(switchview.router)  # Switch-Ansicht: was hängt an welchem Port
